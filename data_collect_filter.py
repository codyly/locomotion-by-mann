...
def main(root_dir, num_samp, skill_id, filt_tag):
    ...
    while True:
        ...
        depth_name = "{}/depth_{:02d}_{:08d}.pfm".format(save_dir, skill_id, cnt)
        color_name = "{}/color_{:02d}_{:08d}.png".format(save_dir, skill_id, cnt)

        segImg[segImg == -1] = 0
        segImg *= 127
        segm_name = "{}/segm_{:02d}_{:08d}.png".format(save_dir, skill_id, cnt)
        ...
        json_name = "{}/label_{:02d}_{:08d}.json".format(save_dir, skill_id, cnt)

        tag = np.sum(label["collision"]) > 0
